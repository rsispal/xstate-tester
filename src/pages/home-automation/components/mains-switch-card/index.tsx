...
import { MainsSwitchDevice } from "../../types";

interface MainsSwitchCardProps extends Omit<MainsSwitchDevice, "type"> {
  onChangeCallback: (id: string, status: boolean) => void;
}
export const MainsSwitchCard: FC<MainsSwitchCardProps> = ({ id, name, room, status, onChangeCallback }) => {
  ...
  const renderSwitchControl = () => <Switch colorScheme="purple" size="lg" isChecked={status} onChange={handleChange} />;
  return (
    <Box
      display="flex"
